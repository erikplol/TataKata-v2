...
<div class="min-h-screen flex items-center justify-center bg-[#e8e8e8]">
    <div class="w-[90vw] h-[90vh] grid grid-cols-[37%_63%] rounded-[2.5rem] overflow-hidden border-[6px] border-[#3d3d5c] shadow-[0_0_30px_rgba(0,0,0,0.3)]">
        ...
        {{-- Bagian Kanan (Gradasi abu-biru dengan semburat cahaya) --}}
        <div class="relative bg-gradient-to-br from-[#9a9aaa] via-[#8b92b8] to-[#7a90c8] flex flex-col justify-center p-16 overflow-y-auto">
            ...
            <div class="relative bg-gradient-to-br from-[#ebebeb] to-[#f5f5f5] p-6 rounded-[2rem] shadow-[0_8px_30px_rgba(0,0,0,0.15),0_0_20px_rgba(30,58,138,0.2)] border-[3px] border-[#1E3A8A] max-w-md mx-auto w-full my-8" style="box-shadow: 0 8px 30px rgba(0,0,0,0.15), 0 0 15px rgba(30,58,138,0.3), inset 0 1px 0 rgba(255,255,255,0.3);">
                <h2 class="text-lg font-semibold text-[#1a1a2e] mb-4 text-center">Buat Akun Tata Kata Anda</h2>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-2.5">
                    ...
                    <div>
                        <label for="first_name" class="block text-xs font-semibold text-[#1a1a2e] mb-1">Nama Depan</label>
                        <input id="first_name" type="text" name="first_name" value="{{ old('first_name') }}" required autofocus
                            class="w-full px-3 py-2 text-sm rounded-md border border-gray-300 bg-white text-[#1a1a2e] placeholder-gray-400 focus:border-[#3d3d5c] focus:ring-1 focus:ring-[#3d3d5c] outline-none transition">
                    </div>

                    <div>
                        <label for="last_name" class="block text-xs font-semibold text-[#1a1a2e] mb-1">Nama Belakang</label>
                        <input id="last_name" type="text" name="last_name" value="{{ old('last_name') }}" required
                            class="w-full px-3 py-2 text-sm rounded-md border border-gray-300 bg-white text-[#1a1a2e] placeholder-gray-400 focus:border-[#3d3d5c] focus:ring-1 focus:ring-[#3d3d5c] outline-none transition">
                    </div>

                    <div>
                        <label for="email" class="block text-xs font-semibold text-[#1a1a2e] mb-1">Alamat Email</label>
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required
                            class="w-full px-3 py-2 text-sm rounded-md border border-gray-300 bg-white text-[#1a1a2e] placeholder-gray-400 focus:border-[#3d3d5c] focus:ring-1 focus:ring-[#3d3d5c] outline-none transition">
                    </div>

                    <div>
                        <label for="password" class="block text-xs font-semibold text-[#1a1a2e] mb-1">Kata Sandi</label>
                        <input id="password" type="password" name="password" required
                            class="w-full px-3 py-2 text-sm rounded-md border border-gray-300 bg-white text-[#1a1a2e] placeholder-gray-400 focus:border-[#3d3d5c] focus:ring-1 focus:ring-[#3d3d5c] outline-none transition">
                    </div>

                    <div>
                        <label for="password_confirmation" class="block text-xs font-semibold text-[#1a1a2e] mb-1">Konfirmasi Kata Sandi</label>
                    ...
                    <div class="pt-1.5">
                        <button type="submit"
                            class="w-full py-2 px-6 text-sm bg-[#1a1a2e] text-white rounded-full font-semibold shadow-md hover:bg-[#2d2d44] transition duration-200">
                            Daftar
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-4 text-center">
                    <div class="border-t border-[#1a1a2e]/20 my-2.5"></div>
